		...
		<div id="content-wrapper">
			...
			<div class="container-fluid">
				...
				<div class="card mb-3">
					...
					<form action="<?php base_url('admin/pembayaran/editBayar') ?>" method="post" enctype="multipart/form-data" >
									
					<input type="hidden" name="id_bayar" value="<?php echo $bayar['id_bayar']?>" />
					
									<div class="form-group">
										<label for="id_pasien">Id Pasien*</label>
										<input class="form-control <?php echo form_error('id_pasien') ? 'is-invalid':'' ?>"
										 type="text" name="id_pasien" placeholder=" Id Pasien " value="<?php echo $bayar['pasien_id'] ?>" />
									...
									<div class="form-group">
										...
										<input class="form-control <?php echo form_error('nama_dokter') ? 'is-invalid':'' ?>"
										 type="text" name="nama_dokter" min="0" placeholder="Nama Dokter"   value="<?php echo $bayar['nama_dokter'] ?>"/>
										<div class="invalid-feedback">
									...
									<div class="form-group">
										...
										<input class="form-control-file <?php echo form_error('tanggal') ? 'is-invalid':'' ?>"
										 type="date" name="tanggal"  min="0" placeholder="Tanggal"  value="<?php echo $bayar['tanggal'] ?>"  />
										<div class="invalid-feedback">
									...
									<div class="form-group">
										...
										<input class="form-control-file <?php echo form_error('id_tindakan') ? 'is-invalid':'' ?>"
										 type="number" name="id_tindakan"  min="0" placeholder="id tindakan"  value="<?php echo $bayar['id_tindakan'] ?>"  />
										<div class="invalid-feedback">
									...
									<div class="form-group">
										...
										<input class="form-control-file <?php echo form_error('tindakan') ? 'is-invalid':'' ?>"
										 type="text" name="tindakan"  min="0" placeholder=" Jenis Tindakan "   value="<?php echo $bayar['jenis_tindakan'] ?>"/>
										<div class="invalid-feedback">
									...
									<div class="form-group">
										...
										<input class="form-control <?php echo form_error('id_bayar1') ? 'is-invalid':'' ?>"
										 type="text" name="id_bayar1" placeholder=" Id Pembayaran "  value="<?php echo $bayar['id_bayar'] ?>" />
										<div class="invalid-feedback">
									...
									<div class="form-group">
										...
										<input class="form-control <?php echo form_error('id_pasien1') ? 'is-invalid':'' ?>"
										 type="text" name="id_pasien1" placeholder=" Id Pasien "  value="<?php echo $bayar['id_pasien'] ?>"/>
										<div class="invalid-feedback">
									...
									<div class="form-group">
										...
										<input class="form-control-file <?php echo form_error('tarif') ? 'is-invalid':'' ?>"
										 type="number" name="tarif"  min="0" placeholder="  Tarif "  value="<?php echo $bayar['tarif'] ?>" />
										<div class="invalid-feedback">
