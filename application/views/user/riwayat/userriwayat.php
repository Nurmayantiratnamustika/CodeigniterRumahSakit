			...
			<div class="container-fluid">
				...
				<div class="card mb-3">
					<div class="card-header">
						...
						<a href="<?php echo site_url('user/pembayaran/addBayar') ?>"><i class="fas fa-plus"></i> Add New</a>
					</div>
					<div class="card-body">
...
?>
								...
								<tbody>
										...
										<td width="250">
                                        <a href="<?php echo site_url('user/userriwayat/laporan_pdf/'.$id) ?>"
											 class="btn btn-small"><i class="fa fa-print"></i> Print</a> 
											
                                             <a href="<?php echo site_url('user/userriwayat/detail/'.$id) ?>"
